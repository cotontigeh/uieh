...
export const textareaVariants = cva({
  ...
  variants: {
    ...
    color: {
      ...
      primary: ['ring-primary/70 focus:ring-primary'],
      secondary: ['ring-secondary/70 focus:ring-secondary'],
      accent: ['ring-accent/70 focus:ring-accent'],
      neutral: ['ring-neutral/70 focus:ring-neutral'],
      info: ['ring-info/70 focus:ring-info'],
      success: ['ring-success/70 focus:ring-success'],
      warning: ['ring-warning/70 focus:ring-warning'],
      error: ['ring-error/70 focus:ring-error']
    },
    disabled: {
      unset: null,
      true: [
